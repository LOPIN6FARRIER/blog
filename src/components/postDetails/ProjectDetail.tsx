  ...
  return (
    <article className="max-w-5xl mx-auto">
      ...
      {post.technologies && post.technologies.length > 0 && (
        <div className="mb-8 p-6 bg-blue-50 dark:bg-gray-900/50 rounded-xl">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        {post.repoUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 hover:bg-gray-950 dark:bg-gray-800 dark:hover:bg-zinc-600 text-white rounded-lg font-medium transition-colors"
          >
